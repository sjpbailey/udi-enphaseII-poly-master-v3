...
"""response2 = requests.get(
    'https://api.enphaseenergy.com/api/v2/systems/2527105/energy_lifetime',  params=params).text  # ?+end_scnd+'&end_date='+end_scndstart_date='+start_date+'&end_date='+end_date,
#print('\n Summary \n' + response)
jsonResponse = json.loads(response2)

#print('\n Lifetime Energy Response 1-2 Report \n' + jsonResponse)


# for i in jsonResponse[0:0]:
#    print(i)

# print(type(jsonResponse))
# print(jsonResponse['production'][52])
# print(len(jsonResponse['production']))
# print(len(jsonResponse['production'])-1)
# print(len(jsonResponse['production'])-2)
ystdy = len(jsonResponse['production'])-1
dybfo = len(jsonResponse['production'])-2
dybfy = len(jsonResponse['production'])-3

print(jsonResponse['production'][ystdy]/1000)  # Yesterday
print(jsonResponse['production'][dybfo]/1000)  # Two Days Ago
print(jsonResponse['production'][dybfy]/1000)  # Three Days Ago"""
...
print('\n Lifetime Energy Response 4 Report \n' + response4)
print('\n Lifetime Energy Response 4 Report \n' +
      response4 + '\n On \n' + end_tird)
